...
class EntityDescriptorFunctionalTest extends \PHPUnit_Framework_TestCase
{
    public function testDeserializationIdp2Ed()
    {
        ...
        $this->assertContainsOnly('AerialShip\LightSaml\Model\Metadata\SingleLogoutService', $sp->getAllSingleLogoutServices());
        $this->assertContainsOnly('AerialShip\LightSaml\Model\Metadata\AssertionConsumerService', $sp->getAllAssertionConsumerServices());
        ...
        $this->assertContainsOnly('AerialShip\LightSaml\Model\Metadata\SingleLogoutService', $idp->getAllSingleLogoutServices());
        $this->assertContainsOnly('AerialShip\LightSaml\Model\Metadata\SingleSignOnService', $idp->getAllSingleSignOnServices());
    ...
    private function checkACS(SpSsoDescriptor $sp, $binding, $location, $index, $isDefault)
    {
        ...
        $this->assertEquals($isDefault, $svc->getIsDefault());
    }
